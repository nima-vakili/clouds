...
EXCEPT ASSIGNMENTS, AND SET IT TO NONE!
...
#    exponent = 20
#    n_replica = 50
#    x = np.linspace(0., 1., n_replica)**exponent
#    beta_0 = beta_min + x / (beta_max - beta_min)
#    beta_0[-1] = 1.0
#    
    beta_0 = np.linspace(1e-10, 1., 50)
    ############################
    ...
    for i in range(len(beta_0)):
        ...
        posterior, gibbs = create_replica(dataset, K, beta_0[i], index, n_steps=n_steps, n_neighbors=n_neighbors)
    ...
    if  False :
        ...
        path_0 = '/home/nvakili/Documents/PYTHON_CODES/weekly_experiments/23.3.2018/test_Replica_Parallel_NoneZ_2_4_500_25_500/'
    ...
    if  False:
        ...
        path_0 = '/home/nvakili/Documents/PYTHON_CODES/weekly_experiments/4.4.2018/test_RevisedParallel_NoneZ_Version2/'
#        beta_0 = np.load(os.path.join(path_0, 'newbeta_NoneZ_2_4_500_Version1.npz'))['arr_0']
    ...
    if  False:
        ...
        ax[0].axhline(L_max_NoneZ_Version2, ls='--', lw=2, color='r')
        ...
        ax[1].set_xlim(0,len(beta_0))
    
        colors = plt.cm.jet(np.linspace(0.,1.,len(beta_0)))
        ...
        ax[3].axhline(P_max_NoneZ_Version2, ls='--', lw=2, color='r')
    ...
    if False:
        ...
        q = np.multiply.outer(beta_0, E.flatten())
        ...
        plt.figure()
        plt.plot(np.linspace(0.,1.,len(beta_0)),beta_0)
